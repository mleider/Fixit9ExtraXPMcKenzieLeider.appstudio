...
const cacheName = 'Fixit9ExtraXPMcKenzieLeider-2020-10-17 11:26:53.908880'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9ExtraXPMcKenzieLeider'.length) === 'Fixit9ExtraXPMcKenzieLeider') {
